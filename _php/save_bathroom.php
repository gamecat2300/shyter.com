...
$sql = "INSERT INTO bathrooms (bathroom_name, type, street_address, street_address2, city, hours, contact_email,contact_name,phone, why_sf, is_hiring, lat, lng, date, rating)
VALUES
('$_POST[bathroom_name]','$_POST[type]','$_POST[street_address]','$_POST[street_address2]','$_POST[city]','$_POST[hours]','$_POST[contact_email]','$_POST[contact_name]','$_POST[phone]','$_POST[why_sf]','$_POST[is_hiring]','$_POST[latitude]','$_POST[longitude]','$_POST[date]','$_POST[rating]')";
...
mysqli_close($conn);
  ...
  $bathroom_name = $_POST['bathroom_name'];
  $source = $_POST['date'];
  ...
  $street_address = $_POST['street_address'];
    ...
    <tr>
      <td style="background: #eee;">Bathroom Name:</td><td>'.$bathroom_name.'</a></td>
    </tr>
    <tr>
